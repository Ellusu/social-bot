<div class="scb_box">
    ...
    <p class="meta-options scb_field">
        <label for="scb_error_msg"><?php echo __('Error message', 'social-bot'); ?></label>
    ...
    <p class="meta-options scb_field">
        <label for="scb_delete_user_msg"><?php echo __('Message that subscribers can use to unsubscribe', 'social-bot'); ?></label>
...
<span class="helper"><?php echo __('To create your own Facebook Messenger Bot you can do it on <a href="https://developers.facebook.com/apps/create/" target="_blank">the official Developer Facebook page', 'social-bot'); ?></a></span>
<script>
